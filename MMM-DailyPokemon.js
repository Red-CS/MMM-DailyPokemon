...
Module.register("MMM-DailyPokemon", {
      ...
      if (this.readyState == 4 && this.status == 200) {
        ...
        if (languageChosen) {
          ...
          if (flavorTextDisplay) {
            ...
            var flavorTextObj =
              response.flavor_text_entries.find(checkLanguage);
  ...
  createContent: function (data, wrapper) {
    ...
    type1Img.src =
      "https://serebii.net/pokedex-dp/type/" + data.types[0].type.name + ".gif";
    if (this.config.grayscale) {
    ...
    if (data.types[1]) {
      ...
      type2Img.src =
        "https://serebii.net/pokedex-dp/type/" +
